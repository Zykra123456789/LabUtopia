...
class PourTask(BaseTask):
    ...
    def reset(self):
        ...
        self.target_beaker = self.cfg.task.obj_paths[1]['path']
        ...
        self.object_utils.set_object_position(object_path=self.target_beaker, position=target_position)
    ...
    def step(self):
        ...
        source_quaternion = self.object_utils.get_transform_quat(object_path=self.source_beaker+"/mesh")
        ...
        return {
            ...
            'target_name': self.target_beaker.split("/")[-1],
